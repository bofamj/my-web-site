...
//*  handell the contact button */
const contectBtn = document.getElementById("subBtn");
console.log(contectBtn);
contectBtn.addEventListener("click", (e) => {
  e.preventDefault();

  //* @desc emti the input filed after submiting the form */
  let maile = e.target.parentNode.childNodes[1].childNodes[3];
  maile.value = "";
  let text = e.target.parentNode.childNodes[3].childNodes[3];
  text.value = "";
});
